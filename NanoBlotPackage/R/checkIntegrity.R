#' Calculate Integrity 
#' 
#' @param GeneTargets The result of running bamFilesToNanoblotData
#' @param DataSet An optional title for the resulting plot.
#' @export
#' @examples
#' makeNanoblot()
#' 
...
calculateIntegrity <- function(GeneTargets, DataSet) {
